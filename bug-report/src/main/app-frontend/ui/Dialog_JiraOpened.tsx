    ...
    render() {
        return <div className={'ll_v_s fill'} style={{width: 344}}>
            <div className={'ll_v_s'} style={{flex: 1, position: 'relative'}}>
                <div style={{textAlign: 'center', padding: '10px', fontSize: '16px', color: 'darkslategray'}}>Success
                </div>
                <div style={{textAlign: 'center', padding: '5px', fontSize: '14px', color: 'darkslategray'}}>Bug report
