...
export class DialogFlowApi
    ...
    agent = {
        create: async (agentProjectId: string, name: string) => {
            ...
            await this.dialogFlowApi.projects.setAgent({
                parent: `projects/${agentProjectId}`,
        ...
        restore: async (agentProjectId: string, agentContent: string) => {
            ...
            return (await this.dialogFlowApi.projects.agent.restore({
                parent: `projects/${agentProjectId}`,
        ...
        import: async (agentProjectId: string, agentContent: string) => {
            ...
            return (await this.dialogFlowApi.projects.agent.import({
                parent: `projects/${agentProjectId}`,
                requestBody: {agentContent}
            })).data
        },
    ...
    intent = {
        list: async (agentProjectId: string) => {
            ...
            do {
                const response: {
                    data: Schema$GoogleCloudDialogflowV2ListIntentsResponse
                } = await this.dialogFlowApi.projects.agent.intents.list(
                    {
