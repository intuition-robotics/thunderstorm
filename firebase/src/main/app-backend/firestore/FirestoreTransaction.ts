...
import {BadImplementationException, generateHex, merge, Subset} from "@intuitionrobotics/ts-common";
...
export class FirestoreTransaction {
    ...
    async insert<Type extends object>(collection: FirestoreCollection<Type>, instance: Type, id = generateHex(16)) {
...
//------------------------
    async upsert<Type extends object>(collection: FirestoreCollection<Type>, instance: Type, id?: string) {
        return (await this.upsert_Read(collection, instance, id))();
    }

    async upsert_Read<Type extends object>(collection: FirestoreCollection<Type>, instance: Type, id = generateHex(16)) {
        const ref = await this.getOrCreateDocument(collection, instance, id);
    ...
    private async getOrCreateDocument<Type extends object>(collection: FirestoreCollection<Type>, instance: Type, id: string) {
    ...
    getDoc<Type extends object>(collection: FirestoreCollection<Type>, id: string): Promise<Type | undefined> {
        return collection.getDoc(id);
    }
